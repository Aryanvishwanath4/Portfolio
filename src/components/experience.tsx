  ...
  return (
    ...
    >
      ...
      {experiencesData.map((experience) => (
        <div className="w-auto md:w-[50rem] h-auto border-2 border-solid border-sky-500 shadow-inner shadow-sky-500 mt-[2rem] rounded-lg">
          <div className="px-5 py-4">
            ...
            <ul className="px-5 text-gray-400">
              {experience.description.map((points) => (
                <li className="list-disc text-wrap">{points}</li>
              ))}
            </ul>
          </div>
        </div>
